    ...
    def train(self, model, train_data_loader, val_data_loader, cfg):
        ...
        for epoch_idx in range(init_epoch + 1, cfg.TRAIN.N_EPOCHS + 1):
            ...
            for batch_idx, (taxonomy_ids, model_ids, data) in enumerate(train_data_loader):
                print(f"DEBUG_A: CPU data loaded. Batch ID: {batch_idx}")
            ...
            print(f"DEBUG_CPU_LOADED: Data shape on CPU: {data['partial'].shape if 'partial' in data else 'N/A'}")  # Validate the current model
