...
def ShapeNet55Config():
    ...
    __C.DATASETS.SHAPENET55.COMPLETE_POINTS_PATH     = './datasets/ShapeNet55-34/ShapeNet-55/%s'
...
def train_net(cfg):
    ...
    if torch.cuda.is_available():
        ...
        print(f"DEBUG: Model on device: {next(model.parameters()).device}")
...
if __name__ == '__main__':
    ...
    if torch.cuda.is_available():
        ...
        print("DEBUG: CUDA device 0 explicitly set.")
