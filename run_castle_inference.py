...
# --- 設定パラメータ ---
MODEL_PATH = '/mnt/c/Users/horiy/OneDrive/デスクトップ/shapenet55/ShapeNet-55/ckpt-best.pth' # ★パス確認
INPUT_PLY = 'kumasoto1.ply'             # 元の87万点のファイル
OUTPUT_PLY = 'kumamoto_overlap_repaired_SOR_cleaned.ply'
...
def run_inference():
    ...
    Model = import_module('codes.model')
